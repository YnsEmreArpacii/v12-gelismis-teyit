...
exports.run = async (client, msg, args) => {
  msg.delete();
  const yasak = client.emojis.cache.get('819251524286939196');
  if (msg.channel.id !== '831713535347654689') return msg.channel.send(`${yasak} **Bu komutun kullanımı, bu kanalda engellenmiştir.**`).then(m => m.delete(5000));
